  ...
  projets: [
    {
      ...
      description:
        "Ma mission pour ce projet était de développer un site “mobile first” qui répertorie les menus de restaurants gastronomiques.",
    ...
    },
    {
      ...
      description:
        "Ma mission pour ce projet était de dynamiser le site Internet statique d’une petite imprimerie familiale nommée Print it.",
      ...
      tags: ["html", "css", "git", "JS"],
    },
    {
      title: "Sophie Bluel",
      picture: "images/projets/hotel-first-arte-new-delhi.png",
      description:
        "Pour ce projet, j'ai apporté mon aide sur le front-end à une équipe qui travaillait sur la conception du site portfolio d’une architecte d’intérieur.",
      ...
      tags: ["html", "css", "sass", "git", "JS", "Api"],
    },
    {
      title: "Kasa",
      picture: "images/projets/img-banner-a-propos (1).jpg",
      description:
        "Kasa voulait effectuer une refonte totale du site, pour passer à une stack complète en JavaScript avec NodeJS côté back-end, et React côté front-end. Pour ce projet, j'ai travaillé sur la partie front-end.",
      ...
      tags: ["html", "css", "sass", "git", "JS", "React", "Api"],
    },
    {
      title: "Nina Carducci",
      picture: "images/projets/hannah-busing-RvF2R_qMpRk-unsplash.webp",
      description:
        "Pour ce projet, j'ai travaillé sur l’optimisation SEO du site de Nina Carducci, une photographe.",
